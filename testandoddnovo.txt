...
Stroke=Color3.fromRGB(33,33,33),
...
Blue = {
    Colors = {
        Background = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 25, 50)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 25, 50))
        },
        Primary = Color3.fromRGB(65, 150, 255),
        OnPrimary = Color3.fromRGB(255, 255, 255),
        ScrollBar = Color3.fromRGB(65, 150, 255),
        Stroke = Color3.fromRGB(30, 50, 80),
        Error = Color3.fromRGB(255, 102, 102),
        Icons = Color3.fromRGB(200, 220, 255),
        JoinButton = Color3.fromRGB(37, 128, 69),
        Link = Color3.fromRGB(40, 150, 255),
        Dialog = { Background = Color3.fromRGB(10, 20, 40) },
        Buttons = {
            Holding = Color3.fromRGB(40, 80, 140),
            Default = Color3.fromRGB(25, 50, 90)
        },
        Border = {
            Holding = Color3.fromRGB(60, 120, 200),
            Default = Color3.fromRGB(35, 60, 100)
        },
        Text = {
            Default = Color3.fromRGB(220, 235, 255),
            Dark = Color3.fromRGB(170, 195, 230),
            Darker = Color3.fromRGB(130, 160, 200)
        },
        Slider = {
            SliderBar = Color3.fromRGB(65, 150, 255),
            SliderNumber = Color3.fromRGB(232, 233, 235)
        },
        Dropdown = {
            Holder = Color3.fromRGB(10, 20, 40)
        }
    },
    Icons = {
        Error = "rbxassetid://10709752996",
...
Purple = {
    Colors = {
        ...
        OnPrimary = Color3.fromRGB(255, 255, 255),
        ScrollBar = Color3.fromRGB(180, 80, 255),
        Stroke = Color3.fromRGB(45, 30, 70),
        Error = Color3.fromRGB(255, 80, 80),
        Icons = Color3.fromRGB(210, 180, 240),
        JoinButton = Color3.fromRGB(37, 128, 69),
        Link = Color3.fromRGB(100, 180, 255),
        Dialog = { Background = Color3.fromRGB(15, 5, 30) },
        Buttons = {
            Holding = Color3.fromRGB(70, 40, 110),
            Default = Color3.fromRGB(40, 25, 65)
        },
        Border = {
            Holding = Color3.fromRGB(120, 70, 180),
            Default = Color3.fromRGB(50, 30, 80)
        },
        Text = {
            Default = Color3.fromRGB(235, 220, 250),
            Dark = Color3.fromRGB(190, 170, 220),
            Darker = Color3.fromRGB(150, 130, 190)
        },
        Slider = {
            SliderBar = Color3.fromRGB(180, 80, 255),
            SliderNumber = Color3.fromRGB(232, 233, 235)
        },
        Dropdown = {
            Holder = Color3.fromRGB(15, 5, 30)
        }
    },
    Icons = {
        Error = "rbxassetid://10709752996",
...
Green = {
    Colors = {
        Background = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 35, 20)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 35, 20))
        },
        ...
        Error = Color3.fromRGB(255, 80, 80),
        Icons = Color3.fromRGB(180, 240, 210),
        JoinButton = Color3.fromRGB(37, 128, 69),
        Link = Color3.fromRGB(40, 200, 255),
        Dialog = { Background = Color3.fromRGB(5, 25, 12) },
        Buttons = {
            Holding = Color3.fromRGB(30, 90, 60),
            Default = Color3.fromRGB(20, 55, 35)
        },
        Border = {
            Holding = Color3.fromRGB(40, 130, 80),
            Default = Color3.fromRGB(25, 70, 45)
        },
        Text = {
            Default = Color3.fromRGB(220, 255, 235),
            Dark = Color3.fromRGB(170, 220, 190),
            Darker = Color3.fromRGB(130, 190, 155)
        },
        Slider = {
            SliderBar = Color3.fromRGB(0, 200, 120),
            SliderNumber = Color3.fromRGB(232, 233, 235)
        },
        Dropdown = {
            Holder = Color3.fromRGB(5, 25, 12)
        }
    },
    Icons = {
        Error = "rbxassetid://10709752996",
...
Red = {
    Colors = {
        Background = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(40, 10, 15)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(40, 10, 15))
        },
        Primary = Color3.fromRGB(255, 70, 70),
        OnPrimary = Color3.fromRGB(255, 255, 255),
        ScrollBar = Color3.fromRGB(255, 70, 70),
        Stroke = Color3.fromRGB(70, 25, 35),
        Error = Color3.fromRGB(255, 102, 102),
        Icons = Color3.fromRGB(255, 200, 200),
        JoinButton = Color3.fromRGB(37, 128, 69),
        Link = Color3.fromRGB(255, 180, 80),
        Dialog = { Background = Color3.fromRGB(30, 5, 8) },
        Buttons = {
            Holding = Color3.fromRGB(110, 35, 45),
            Default = Color3.fromRGB(70, 20, 30)
        },
        Border = {
            Holding = Color3.fromRGB(180, 55, 70),
            Default = Color3.fromRGB(80, 25, 40)
        },
        Text = {
            Default = Color3.fromRGB(255, 230, 230),
            Dark = Color3.fromRGB(220, 180, 180),
            Darker = Color3.fromRGB(190, 140, 140)
        },
        Slider = {
            SliderBar = Color3.fromRGB(255, 70, 70),
            SliderNumber = Color3.fromRGB(232, 233, 235)
        },
        Dropdown = {
            Holder = Color3.fromRGB(30, 5, 8)
        }
    },
    Icons = {
        Error = "rbxassetid://10709752996",
...
Pink = {
    Colors = {
        Background = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(40, 10, 30)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(40, 10, 30))
        },
        Primary = Color3.fromRGB(255, 80, 180),
        OnPrimary = Color3.fromRGB(255, 255, 255),
        ScrollBar = Color3.fromRGB(255, 80, 180),
        Stroke = Color3.fromRGB(70, 25, 55),
        Error = Color3.fromRGB(255, 102, 102),
        Icons = Color3.fromRGB(255, 200, 230),
        JoinButton = Color3.fromRGB(37, 128, 69),
        Link = Color3.fromRGB(100, 200, 255),
        Dialog = { Background = Color3.fromRGB(30, 5, 20) },
        Buttons = {
            Holding = Color3.fromRGB(110, 35, 80),
            Default = Color3.fromRGB(70, 20, 50)
        },
        Border = {
            Holding = Color3.fromRGB(180, 55, 130),
            Default = Color3.fromRGB(80, 25, 60)
        },
        Text = {
            Default = Color3.fromRGB(255, 230, 240),
            Dark = Color3.fromRGB(220, 180, 200),
            Darker = Color3.fromRGB(190, 140, 165)
        },
        Slider = {
            SliderBar = Color3.fromRGB(255, 80, 180),
            SliderNumber = Color3.fromRGB(232, 233, 235)
        },
        Dropdown = {
            Holder = Color3.fromRGB(30, 5, 20)
        }
    },
    Icons = {
        Error = "rbxassetid://10709752996",
...
Orange = {
    Colors = {
        Background = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(45, 25, 10)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(45, 25, 10))
        },
        Primary = Color3.fromRGB(255, 150, 50),
        OnPrimary = Color3.fromRGB(255, 255, 255),
        ScrollBar = Color3.fromRGB(255, 150, 50),
        Stroke = Color3.fromRGB(75, 45, 25),
        Error = Color3.fromRGB(255, 102, 102),
        Icons = Color3.fromRGB(255, 220, 180),
        JoinButton = Color3.fromRGB(37, 128, 69),
        Link = Color3.fromRGB(100, 200, 255),
        Dialog = { Background = Color3.fromRGB(35, 15, 5) },
        Buttons = {
            Holding = Color3.fromRGB(120, 70, 30),
            Default = Color3.fromRGB(75, 40, 20)
        },
        Border = {
            Holding = Color3.fromRGB(190, 110, 50),
            Default = Color3.fromRGB(85, 45, 25)
        },
        Text = {
            Default = Color3.fromRGB(255, 240, 220),
            Dark = Color3.fromRGB(220, 195, 170),
            Darker = Color3.fromRGB(190, 160, 130)
        },
        Slider = {
            SliderBar = Color3.fromRGB(255, 150, 50),
            SliderNumber = Color3.fromRGB(232, 233, 235)
        },
        Dropdown = {
            Holder = Color3.fromRGB(35, 15, 5)
        }
    },
    Icons = {
        Error = "rbxassetid://10709752996",
...
Cyan = {
    Colors = {
        Background = ColorSequence.new{
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(5, 35, 45)),
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(5, 35, 45))
        },
        Primary = Color3.fromRGB(0, 220, 255),
        OnPrimary = Color3.fromRGB(255, 255, 255),
        ScrollBar = Color3.fromRGB(0, 220, 255),
        Stroke = Color3.fromRGB(15, 60, 75),
        Error = Color3.fromRGB(255, 102, 102),
        Icons = Color3.fromRGB(180, 240, 255),
        JoinButton = Color3.fromRGB(37, 128, 69),
        Link = Color3.fromRGB(40, 200, 255),
        Dialog = { Background = Color3.fromRGB(3, 25, 35) },
        Buttons = {
            Holding = Color3.fromRGB(20, 100, 130),
            Default = Color3.fromRGB(10, 60, 80)
        },
        Border = {
            Holding = Color3.fromRGB(30, 150, 190),
            Default = Color3.fromRGB(15, 70, 90)
        },
        Text = {
            Default = Color3.fromRGB(220, 248, 255),
            Dark = Color3.fromRGB(170, 210, 230),
            Darker = Color3.fromRGB(130, 175, 200)
        },
        Slider = {
            SliderBar = Color3.fromRGB(0, 220, 255),
            SliderNumber = Color3.fromRGB(232, 233, 235)
        },
        Dropdown = {
            Holder = Color3.fromRGB(3, 25, 35)
        }
    },
    Icons = {
        Error = "rbxassetid://10709752996",
...
Default={
Theme="Darker",
UISize=UDim2.fromOffset(463,241),
TabSize=160
},
...
local a_ = aZ:FindFirstChild("TextLabel")
local a0 = aZ:FindFirstChild("Frame")
if not (a_ and a0) then
    return
end
...
local aA={
Title="Fechar Janela?",
Content="Deseja fechar a interface de usuário?",
Options={
{
Title="Sim",
